...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[var(--heading)] border-t border-[rgba(255,255,255,0.08)] pt-16 pb-8 text-[#BFC4CF] relative overflow-hidden">
      <div className="max-w-[1180px] mx-auto px-7 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-[rgba(255,255,255,0.08)]">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                href="#"
                className="w-9 h-9 rounded-full bg-white/5 border border-[rgba(255,255,255,0.08)] flex items-center justify-center text-[#BFC4CF] hover:text-owncart-primary hover:bg-white/10 hover:border-white/20 transition-all"
          ...
          {footerColumns.map((col) => (
            <div key={col.title} className="flex flex-col gap-3.5">
              <h4 className="text-[13px] font-bold text-white/50 tracking-[0.08em] uppercase">
                {col.title}
              </h4>
        ...
        {/* Bottom copyright */}
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[13px] text-[#BFC4CF]/70">
          <p>© {new Date().getFullYear()} Owncart. Made for sellers, not spreadsheets.</p>
          <p className="flex items-center gap-1">
            <span>Crafted with</span>
            <Heart className="w-3.5 h-3.5 text-owncart-accent fill-owncart-accent animate-pulse" />
